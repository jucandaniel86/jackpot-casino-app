<?php
	...
	class RefundController extends Controller
	{
		...
		public function __invoke(Request $request, GameForge $gameForge): JsonResponse
		{
			...
			return response()->json($registry->refund($request));
		}

		/**
		 * @param Request $request
		 * @param GameForge $gameForge
		 * @return JsonResponse
		 */
		public function casinoRefund(Request $request, GameForge $gameForge): JsonResponse
		{
			...
			return response()->json($provider->refund($request));
		}
	}